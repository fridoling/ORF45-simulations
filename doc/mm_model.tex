...
\begin{document}
	...
	\begin{figure}[h!]
		\centering \includegraphics[width=0.5\linewidth]{scheme.pdf}
	...
	\begin{figure}[h!]
		\centering \includegraphics[width=\linewidth]{layout.pdf}
	...
	\begin{figure}[h!]
		\centering \includegraphics[width=0.45\linewidth]{ekin.pdf}
		\includegraphics[width=0.45\linewidth]{rkin.pdf}\\
		\includegraphics[width=0.45\linewidth]{epp.pdf}
		\includegraphics[width=0.45\linewidth]{rpp2.pdf}
